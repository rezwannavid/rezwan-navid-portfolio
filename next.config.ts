...
const contentSecurityPolicy = [
  ...
  "font-src 'self' data:",
  "media-src 'self' blob:",
  `connect-src 'self'${isDevelopment ? " ws://localhost:* wss://localhost:*" : ""} https://*.google-analytics.com https://*.analytics.google.com https://*.clarity.ms https://*.bing.com`,
    ...
    return [
      {
        ...
        headers: [
          { key: "Content-Security-Policy", value: contentSecurityPolicy },
          {
            ...
            value: isDevelopment ? "max-age=0" : "max-age=63072000; includeSubDomains; preload",
          },

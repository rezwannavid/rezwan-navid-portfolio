    ...
    <footer className="home-site-footer home-shell">
      <motion.div ref={closingRef} className="closing-art" initial={{ opacity: .2, scale: .992 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true, amount: .12 }} transition={{ duration: .78, ease: motionEase.editorial }}>
        ...
        <nav className="closing-nav" aria-label="Footer navigation">
          <Link href="/">home</Link><Link href="/work">work</Link><Link href="/about">about</Link><Link href="/contact">contact</Link><Link href="/portfolio">portfolio</Link><Link href="/photography">lens</Link>
        </nav>
        <nav className="closing-socials" aria-label="Social links">
          ...
          <a href="https://www.linkedin.com/in/rezwannavid" aria-label="LinkedIn"><img src="/home-design/footer-linkedin.svg" alt="" width="24" height="24" loading="lazy" /></a>
          <a href="https://threads.net/@rezwannavid" aria-label="Threads"><img src="/home-design/footer-threads.svg" alt="" width="24" height="24" loading="lazy" /></a>

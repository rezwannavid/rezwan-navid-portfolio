    ...
    <footer className="site-footer">
      <Container className="footer-inner">
        <div className="footer-left">
          <Link href="/" aria-label="Rezwan Navid, home"><img className="footer-logo" src="/RNLogo.svg" alt="" width="107" height="39" /></Link>
        ...
        <p className="impact"><span>Create</span><span>with Impact</span></p>
      </Container>
    </footer>
  );
}

      ...
      <main>
        ...
        <CaseStudyShell className="heavygari-composition">
          ...
          <div className="heavygari-first-pair">
            <ProjectVisual native src={media("Introduction")} alt="HeavyGari introduction screen in a phone mockup" width={5340} height={9276} className="heavygari-introduction" distance={9} delay={.03} />
            <ProjectVisual native src={media("Home")} alt="HeavyGari home and booking entry screen in a phone mockup" width={5340} height={9276} className="heavygari-home" distance={-9} delay={.08} />
          </div>
          ...
          <div className="heavygari-editorial-stage">
            <ProjectVisual native src={media("Vehicle Selection")} alt="HeavyGari vehicle and service selection screen" width={5340} height={9276} className="heavygari-vehicle" distance={10} delay={.03} />
            ...
            <ProjectVisual native src={media("Booking Management")} alt="HeavyGari order and booking management screen" width={5340} height={9276} className="heavygari-booking-management" distance={-8} delay={.08} />
            ...
            <ProjectVisual native src={media("Booking Details")} alt="HeavyGari booking details screen" width={1780} height={3092} className="heavygari-booking-details" distance={8} delay={.04} />
            <ProjectVisual native src={media("Tracking")} alt="HeavyGari booking progression and tracking screen" width={5340} height={9276} className="heavygari-tracking" distance={-8} delay={.08} />
          </div>
